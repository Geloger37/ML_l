...
Используемая модель: https://rusvectores.org/static/models/udpipe_syntagrus.model
"""

class Preprocessing:

    def __init__(self, udpipe_filename: str):
    ...
    def process(self, text="Строка", keep_pos=True, keep_punct=False):
